...
public class ServerConfig extends AbstractConfig {
    ...
    public static class ItemCompatibilityConfig extends AbstractConfig {
        ...
        private List<String> swordEnchantmentsRaw = EntryCollectionBuilder.getKeyList(Registry.ENCHANTMENT, Enchantments.IMPALING);
        @Config(name = "axe_enchantments", category = "enchantments", description = COMPATIBILITY_DESCRIPTION + "axes.")
        private List<String> axeEnchantmentsRaw = EntryCollectionBuilder.getKeyList(Registry.ENCHANTMENT, Enchantments.SHARPNESS, Enchantments.SMITE, Enchantments.BANE_OF_ARTHROPODS, Enchantments.KNOCKBACK, Enchantments.FIRE_ASPECT, Enchantments.MOB_LOOTING, Enchantments.SWEEPING_EDGE, Enchantments.IMPALING);
        @Config(name = "trident_enchantments", category = "enchantments", description = COMPATIBILITY_DESCRIPTION + "tridents.")
        private List<String> tridentEnchantmentsRaw = EntryCollectionBuilder.getKeyList(Registry.ENCHANTMENT, Enchantments.SHARPNESS, Enchantments.SMITE, Enchantments.BANE_OF_ARTHROPODS, Enchantments.KNOCKBACK, Enchantments.FIRE_ASPECT, Enchantments.MOB_LOOTING, Enchantments.SWEEPING_EDGE, Enchantments.QUICK_CHARGE, Enchantments.PIERCING);
        @Config(name = "bow_enchantments", category = "enchantments", description = COMPATIBILITY_DESCRIPTION + "bows.")
        private List<String> bowEnchantmentsRaw = EntryCollectionBuilder.getKeyList(Registry.ENCHANTMENT, Enchantments.PIERCING, Enchantments.MULTISHOT, Enchantments.QUICK_CHARGE, Enchantments.MOB_LOOTING);
        @Config(name = "crossbow_enchantments", category = "enchantments", description = COMPATIBILITY_DESCRIPTION + "crossbows.")
        private List<String> crossbowEnchantmentsRaw = EntryCollectionBuilder.getKeyList(Registry.ENCHANTMENT, Enchantments.FLAMING_ARROWS, Enchantments.PUNCH_ARROWS, Enchantments.POWER_ARROWS, Enchantments.INFINITY_ARROWS, Enchantments.MOB_LOOTING);
        @Config(name = "sword_blacklist", category = "blacklists", description = "Swords" + BLACKLIST_DESCRIPTION)
        private List<String> swordBlacklistRaw = EntryCollectionBuilder.getKeyList(Registry.ITEM);
        @Config(name = "axe_blacklist", category = "blacklists", description = "Axes" + BLACKLIST_DESCRIPTION)
        private List<String> axeBlacklistRaw = EntryCollectionBuilder.getKeyList(Registry.ITEM);
        @Config(name = "trident_blacklist", category = "blacklists", description = "Tridents" + BLACKLIST_DESCRIPTION)
        private List<String> tridentBlacklistRaw = EntryCollectionBuilder.getKeyList(Registry.ITEM);
        @Config(name = "bow_blacklist", category = "blacklists", description = "Bows" + BLACKLIST_DESCRIPTION)
        private List<String> bowBlacklistRaw = EntryCollectionBuilder.getKeyList(Registry.ITEM);
        @Config(name = "crossbow_blacklist", category = "blacklists", description = "Crossbows" + BLACKLIST_DESCRIPTION)
        private List<String> crossbowBlacklistRaw = EntryCollectionBuilder.getKeyList(Registry.ITEM);
        ...
        @Override
        protected void afterConfigReload() {
            EntryCollectionBuilder<Enchantment> enchantmentBuilder = EntryCollectionBuilder.of(Registry.ENCHANTMENT);
            ...
            EntryCollectionBuilder<Item> itemBuilder = EntryCollectionBuilder.of(Registry.ITEM);
